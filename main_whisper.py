...
from stt_whisper import WhisperSTT  # ← CAMBIO: Importar WhisperSTT en lugar de VoskSTT
...
class HybridVoiceAssistant:
    ...
    def __init__(self, conversation_duration: int = 300, whisper_model: str = "tiny"):
        """
        Args:
        ...
        """
        # ← CAMBIO: Usar WhisperSTT con tamaño de modelo configurable
    ...
    async def initialize(self):
        ...
        # ← CAMBIO: Inicializar Whisper (ahora es async)
...
async def main():
    """Función principal"""
    # ← CAMBIO: Puedes elegir el modelo de Whisper aquí
    ...
    assistant = HybridVoiceAssistant(
        conversation_duration=300,  # 5 minutos
        whisper_model="tiny"  # ← Ajusta según tu hardware
    )
